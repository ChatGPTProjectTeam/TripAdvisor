...
class SkyscannerService:
    ...
    def create_AccomodationInfo(self, trip_info:TripInfo) -> AccommodationInfo:
        ...
        return AccommodationInfo(
            ...
            lowest_price = data["data"]["results"]["hotelCards"][0]["lowestPrice"]["price"],
            rating = str(data["data"]["results"]["hotelCards"][0]["reviewsSummary"]["score"]),
    ...
    def create_PlaneInfo(self, trip_info: TripInfo, direction: int) -> PlaneInfo:
