...
8. {travel_sites} 정보를 최대한 활용하여 구체적인 활동을 제안합니다.
9. {travel_sites} 정보를 활용하는 경우, DESCRIPTION 의 내용을 참고할 수 있도록 제공합니다.
"""

ASSISTANT_PROMPT_CREATE_WITH_SEARCH_2 = """
## 1일차
(2024년 5월 9일)
- 오전: 주고쿠 지방 히로시마 XX 평화 기념공원 방문 (추천 이동수단: 도보)
> 주고쿠 지방 히로시마 XX 평화 기념공원은 1945년 8월 6일, 원폭이 투하된 지점으로, 평화와 희망을 상징하는 공원입니다. 
